...
""", unsafe_allow_html=True)
    ...
    if n_tipo_Ativo == "IEC-60255":
        ...
        st.markdown("<div style='color:#ffffff !important;'>Onde $T_{ms}$ é o dial de tempo (Multiplicador de Tempo), $I_{ma}$ é a sobrecorrente máxima admitida e $I_{ac}$ é a corrente de partida (acionamento).</div>", unsafe_allow_html=True)
